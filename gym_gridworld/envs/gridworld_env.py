...
class GridWorldEnv(discrete.DiscreteEnv):
    ...
    W : a wall blocking your path
    G : goal, where the frisbee is located
    The episode ends when you reach the goal or fall in a hole.
    You receive a reward of 0 if you reach the goal, and -1 otherwise.
    """
...
#                                 if newletter in b'W': #Wall, stay put and pay 
# 									newstate = s
                                rew = float(REWARD_ACTION) # reward
                            ...
                            if newletter in b'W':
	                            newstate=s
                            # reward function
                            #rew = float(REWARD_ACTION*(newletter not in b'G')) 
                            if letter in b'G':
                            	rew = 0;
                            else:
                            	rew = float(REWARD_ACTION)
                            li.append((1.0, newstate, rew, done))
